...
//    }
    ...
    var printDiagnosis = function() {
        ...
        var diagnosisText = "<p>From the patient, the history is of ";
    ...
    var printSymptomsAndSigns = function() {
        ...
        if (todaysSigns.length == 0) {
            diagnosisText += "<p>The patient did not exhibit any particular signs today. </p>";
        }
        else {
            diagnosisText += "<p>The patient exhibited the following signs today. </p>";
            diagnosisText += "<ol type='1'>";
