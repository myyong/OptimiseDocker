...
$destinationURL = 'http://www.optimise-ms.org/api/OPTIMISE';
...
// Based on post_request from http://www.jonasjohn.de/snippets/php/post-request.htm
    ...
    if($method=="POST"){
        ...
        $postData='{"CurrentRecord":[{"fieldName":"USUBJID","value":"OPT001"},{"fieldName":"QSSEQ","value":0}],"NewRecord":[{"fieldName":"QSSTRESC","value":2}]}';
